...
export default function PromoSection() {
  return (
    ...
    <div className="flex h-full flex-col justify-center bg-gradient-to-br from-[#4F46E5] to-[#7C3AED] p-8 text-white lg:p-12">
      ...
      <div className="mb-16 flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-white/60">Attendance Tracker</p>
        </div>
      </div>
