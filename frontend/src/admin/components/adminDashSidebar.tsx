...
const Sidebar: FC<SidebarProps> = ({ isOpen, onClose }) => {
  const menuItems = [
    ...
    { id: 'qrcodes', label: 'QR Codes', icon: QrCode, path: '/admin-dashboard/qr-generator' },
    { id: 'logs', label: 'Attendance Logs', icon: FileText, path: '/admin-dashboard/attendance' },
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <NavLink
                  ...
                  className="mt-3 inline-flex items-center gap-2 text-white/60 hover:text-white transition"
                >
