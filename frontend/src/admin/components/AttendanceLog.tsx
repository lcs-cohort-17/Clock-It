...
const C = {
  ...
  focusRing:   'var(--admin-focus-ring)',
  textPrimary: 'var(--admin-text-primary)',
  textSecond:  'var(--admin-text-secondary)',
  textMuted:   'var(--admin-text-muted)',
  link:        'var(--admin-link)',
  rowHover:    'var(--admin-row-hover)',
            ...
            return (
              <button
                ...
                style={{
                  ...
                  background:   isActive ? C.cardBg : C.skeleton,
                ...
                <tbody>
                  ...
                  {!clockLoading && !clockError && filteredClockEvents.map(event => (
                    ...
                    >
                      ...
                      <td style={tdStyle}>
                        <button style={{ fontSize: '13px', color: C.link, background: 'none', border: 'none', cursor: 'pointer', padding: 0, fontFamily: 'inherit' }}>
                          Edit
                        </button>
                      </td>
                    </tr>
