...
// FIX: accept supabase as a parameter and pass it down to getExportData,
// so the export uses the same shared client as the rest of the admin router.
export const exportToSheets = (supabase: SupabaseClient) => {
  return async (req: Request, res: Response) => {
    try {
      ...
      // Step 3 — fetch attendance data from DB using shared client
