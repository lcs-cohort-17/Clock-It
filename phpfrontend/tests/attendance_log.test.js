...
describe('Attendance Log Tests', () => {
    ...
    test('filters by staff name', () => {

        const result =
            AttendanceUtils.filterClockEvents(
                events,
                {
                    search: 'john'
                }
    ...
    test('sorts audit trail descending', () => {
        ...
        const sorted =
            AttendanceUtils.sortAuditTrail(
                audit,
                'desc'
            );
    ...
    test('sorts audit trail ascending', () => {
    ...
    test('creates CSV export', () => {

        const csv =
            AttendanceUtils.formatAuditCSV([
                {
                    timestamp:
                        '2026-05-25',
                    actor:
