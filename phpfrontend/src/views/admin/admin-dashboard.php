...
<head>
    ...
    <title>Clock-It Admin Dashboard</title>
    ...
    <header class="w-full border-b border-gray-200 bg-white px-6 py-4 dark:border-slate-700 dark:bg-slate-800">
        <div class="flex items-center justify-between max-w-7xl mx-auto">
            ...
            <div class="flex items-center gap-6">
                ...
                <span class="text-sm font-semibold text-gray-700 dark:text-gray-300">Admin</span>
            </div>
        </div>
    </header>
    ...
    <main class="max-w-7xl mx-auto p-6 md:p-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-gray-200 dark:border-slate-700 pb-6">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Live overview of your team's attendance.</p>
            </div>
            
            <div class="flex items-center gap-3">
                <button class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium bg-white dark:bg-slate-800 border border-gray-300 dark:border-slate-600 hover:bg-gray-50 dark:hover:bg-slate-700 text-gray-700 dark:text-gray-200 rounded-lg shadow-sm transition-colors duration-150">
