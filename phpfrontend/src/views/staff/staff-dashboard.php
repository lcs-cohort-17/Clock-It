    ...
    <main class="max-w-7xl mx-auto p-6 md:p-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-gray-200 dark:border-slate-700 pb-6">
            ...
            <div class="flex items-center gap-3">
                <a href="<?= e($basePath) ?>/admin-dashboard" class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium bg-white dark:bg-slate-800 border border-gray-300 dark:border-slate-600 hover:bg-gray-50 dark:hover:bg-slate-700 text-gray-700 dark:text-gray-200 rounded-lg shadow-sm transition-colors duration-150">
